...
window.onbeforeunload= () => { 
    if (move > 0) {
       ...
       sessionStorage.setItem('endGame', endGame);
       sessionStorage.setItem('isGameCancel',isGameCancel);
       sessionStorage.setItem('playedPositions', JSON.stringify(playedPositions));
    }
    else {
...
function restoreCookiesAfterRefreshPage() {
    ...
    if(sessionStorage.getItem('move')) {
       move = parseInt(sessionStorage.getItem('move'));
       endGame = sessionStorage.getItem('endGame') === 'true' ? true : false;
       isGameCancel = sessionStorage.getItem('isGameCancel') ? true : false;
       playedPositions = JSON.parse(sessionStorage.getItem('playedPositions'));
