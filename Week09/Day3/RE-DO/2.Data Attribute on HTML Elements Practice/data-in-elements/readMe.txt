...
In this practice, you will be explore the data- attribute on HTML elements. You will be provided an index.html file with a basic form set up to add items to a shopping list.

The form consists of a #name <input> field, representing the name of the list item, as well as a #type <select> field representing the category the item belongs to. The #add button to add the item to the list is currently non-functional.
