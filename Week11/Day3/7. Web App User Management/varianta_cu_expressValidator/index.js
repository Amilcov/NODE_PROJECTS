...
const validateUserWithExpressValidator = (req, res, next) => {
...
app.post('/create', validateUser, [body('password').isLength({min: 5}), body('password').isAlphanumeric()], csrfProtection, (req, res) => {
